...
// Triton 2 patch: re-export the schema validator so patched renderers can
// import it from this module in both Node and browser builds.
export { validateSchema } from './validator.mjs';
